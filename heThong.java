...
public class HeThong extends BOOKDATA.Main {
    ...
    static int giaTien, soLuong, number, tempInt, j, choice, maSach;
    static String space = ("\n");
    ...
    void outputCount() {
        for (int i = 0; i < arrayList.size(); i++) {
            out.println(space + i + ".   " + arrayList.get(i).getTenSach() + "     " + arrayList.get(i).getTacGia() + "     " + arrayList.get(i).getGiaTien() + "     " + arrayList.get(i).getSoLuong());
        }
    }
